...
[Decision trees](https://github.com/Japhilko/DataAnalysis/blob/master/Machine%20Learning/DecisionTrees.md), Ensembles (Bagging, Boosting, Random forest), k-nearest neighbors algorithm (k-NN), [Linear regression](https://github.com/Japhilko/DataAnalysis/blob/master/Regression/SimpleLinearRegression.md), Naive Bayes, [Neural networks](https://en.wikipedia.org/wiki/Artificial_neural_network), Logistic regression, Perceptron, Relevance vector machine (RVM), [Support vector machine (SVM)](https://github.com/Japhilko/DataAnalysis/blob/master/Machine%20Learning/SupportVectorMachines.md)
