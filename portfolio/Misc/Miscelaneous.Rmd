...
- [Journal of Computer Science](http://thescipub.com/journals/jcs)
...
- [Software Journal](http://www.jsoftware.us/list-163-1.html)

- [Journal of Computer Science](http://www.scimagojr.com/journalsearch.php?q=11700154336&tip=sid&clean=0)

- [Journal of Computer Science and Technology](http://www.scimagojr.com/journalsearch.php?q=26132&tip=sid&clean=0)

- [Education and Information Technologies](http://www.scimagojr.com/journalsearch.php?q=144955&tip=sid&clean=0)

- [Journal of Regional Analysis and Policy](http://www.scimagojr.com/journalsearch.php?q=24405&tip=sid&clean=0)

- [gis.science](http://gispoint.de/autorenhinweise/autorenhinweise-gis-science.html)


## Examples for Journal Articles

- maps - [JOSIS](http://www.josis.org/index.php/josis/article/viewFile/240/155)
...
- [R meetups and conferences](https://www.r-bloggers.com/list-of-r-conferences-and-user-groups-2/)
...
- [Github ubuntu](https://www.howtoforge.com/tutorial/install-git-and-github-on-ubuntu-14.04/)
...
- [Interesting Books](https://www.r-bloggers.com/books-i-like/)
...
- [thumbs.db](http://www.giga.de/software/multimedia/welchen-zweck-hat-thumbs.db-und-wie-kann-man-sie-deaktivieren/)


## Time tracking programs

- python + track working time

- [Worklog: A Python Work Time Logger Using SQLite](https://github.com/Maggeych/worklog)

- [Best commandline time tracking application?](https://stackoverflow.com/questions/398344/best-commandline-time-tracking-application)


## Career

- [How to write a Europass CV](https://www.europass.at/fileadmin/dateien_redaktion/lebenslauf/CVInstructionsdt.pdf)

## In the meantime - interesting websites

- [Schockwellenreiter](http://blog.schockwellenreiter.de/index.html)

- [Customizing a github project page](https://help.github.com/articles/customizing-css-and-html-in-your-jekyll-theme/)
